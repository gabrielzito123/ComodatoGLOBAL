local destination = {
	[4121] = {pos = {x = 32801, y = 31766, z = 9}, storage = 1, crystal = false},
	[3220] = {pos = {x = 32627, y = 31863, z = 11}, storage = 1, crystal = false},
	...
	[3215] = {pos = {x = 32369, y = 32241, z = 7}, storage = 1, crystal = false},
	[3216] = {pos = {x = 32212, y = 31133, z = 7}, storage = 1, crystal = false},
	[3217] = {pos = {x = 32317, y = 32825, z = 7}, storage = 1, crystal = false},
	[3218] = {pos = {x = 33213, y = 32454, z = 1}, storage = 1, crystal = false},
	[3219] = {pos = {x = 33217, y = 31814, z = 8}, storage = 1, crystal = false}
}
